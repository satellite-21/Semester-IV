...
HD_PWD='C:/Users/Kartik/Desktop/Digital Design labs/Lab 3/Adder-Subtractor/Adder-Subtractor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_bench.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_bench.tcl -notrace
