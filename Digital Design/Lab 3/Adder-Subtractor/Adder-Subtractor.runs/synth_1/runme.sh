...
HD_PWD='C:/Users/Kartik/Desktop/Digital Design labs/Lab 3/Adder-Subtractor/Adder-Subtractor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_bench.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_bench.tcl
